...
import {
  createActingHodAssignmentByDean,
  getActingHodStatusForDean,
...
export async function GET() {
  try {
    ...
    const result = await getActingHodStatusForDean({ userId: actor.userId });
...
export async function POST(request: Request) {
  try {
    ...
    const result = await createActingHodAssignmentByDean(payload, {
      userId: actor.userId,
    });
